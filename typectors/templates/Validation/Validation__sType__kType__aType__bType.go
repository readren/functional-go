...
func (companion validationCompanion) Combine2__sType__kType__aType__bType(
...
// #dependsOn {"typeCtor":"Validation", "baseTArgs": [{"type":"sType", "type":"kType"}] }
// #dependsOn {"typeCtor":"Errors", "baseTArgs": [{"type":"kType"}] }
func (companion validationCompanion) Map2__sType__kType__aType__bType(
	ka kType, va Validation_aType_by_kType,
	kb kType, vb Validation_bType_by_kType,
	f func(aType, bType) sType,
) Validation_sType_by_kType {
	return companion.Combine2__sType__kType__aType__bType(ka, va, kb, vb, func(a aType, b bType) Validation_sType_by_kType {
