...
func Validate__Combine5__sType__kType__aType__bType__cType__dType__eType(
...
// #dependsOn {"typeCtor":"Validate", "baseTArgs": [{"type":"sType", "type":"kType"}] }
// #dependsOn {"typeCtor":"Errors", "baseTArgs": [{"type":"kType"}] }
func Validate__Map5__sType__kType__aType__bType__cType__dType__eType(
	ka kType, va Validate_aType_idx_kType,
	kb kType, vb Validate_bType_idx_kType,
	kc kType, vc Validate_cType_idx_kType,
	kd kType, vd Validate_dType_idx_kType,
	...
	return Validate__Combine5__sType__kType__aType__bType__cType__dType__eType(ka, va, kb, vb, kc, vc, kd, vd, ke, ve, func(a aType, b bType, c cType, d dType, e eType) Validate_sType_idx_kType {
