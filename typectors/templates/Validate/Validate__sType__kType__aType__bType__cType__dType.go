...
func Validate__Combine4__sType__kType__aType__bType__cType__dType(
...
// #dependsOn {"typeCtor":"Validate", "baseTArgs": [{"type":"sType", "type":"kType"}] }
// #dependsOn {"typeCtor":"Errors", "baseTArgs": [{"type":"kType"}] }
func Validate__Map4__sType__kType__aType__bType__cType__dType(
	ka kType, va Validate_aType_idx_kType,
	kb kType, vb Validate_bType_idx_kType,
	kc kType, vc Validate_cType_idx_kType,
	kd kType, vd Validate_dType_idx_kType,
	...
	return Validate__Combine4__sType__kType__aType__bType__cType__dType(ka, va, kb, vb, kc, vc, kd, vd, func(a aType, b bType, c cType, d dType) Validate_sType_idx_kType {
