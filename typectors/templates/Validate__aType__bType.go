...
func Validate__Successful__aType__bType(a aType) Validate_aType_bType {
...
// #dependsOn {"typeCtor":"Validate", "baseTArgs": [{"type":"aType", "type":"bType"}] }
func Validate__Failed__aType__bType(key bType, err error) Validate_aType_bType {
...
func Validate__Combine2__aType__bType(
	...
	f func(aType, bType) Validate_sType_kType,
...
func Validate__Map2__aType__bType(
	...
	return Validate__Combine2__aType__bType(ka, va, kb, vb, func(a aType, b bType) Validate_sType_kType {
